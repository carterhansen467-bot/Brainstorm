        ...
        with open(self.path, "rb") as handle:
            while offset < self.data_end:
                ...
                if self.schema == 3:
                    ...
                    self._decode_metadata(payload[rank_bytes:], count, associations)
...
class BSP3OutputWriter:
    def __init__(self, reader: BSPoolReader, category_id: str, label: str,
        ...
        self.handle.write(b"\0" * reader.header_bytes)
    ...
    def finalize(self) -> Dict[str, object]:
        ...
        index_offset = self.reader.header_bytes + self.data_bytes
        ...
        header, identity = build_output_header(self.reader, self.category_id,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Inspect and split committed BSP3 occurrence metadata without RNG rescans.")
